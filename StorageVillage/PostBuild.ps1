...
if ($Config -eq "Debug") {
    # Start-Process -FilePath "$Game\bin\Win64_Shipping_Client\Bannerlord.exe" -WorkingDirectory "$Game\bin\Win64_Shipping_Client" -ArgumentList "/singleplayer _MODULES_*$Dependencies*Bannerlord.Harmony*Native*SandBoxCore*SandBox*StoryMode*$Name*_MODULES_ --continue"
}
